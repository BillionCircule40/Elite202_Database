...
def login_check(frame,name,pin):
     ...
     if len(name)<=0 or len(pin)<8 or any(inter.isalpha() for inter in pin):
          ...
          if login_state == False:
               ...
               ac.wigit_sys(failed_login_text)
...
def main():
     ...
     if not login_state :
          if ac_created:
               ...
               ac.wigit_sys(account_create_text)
          print("check1")
